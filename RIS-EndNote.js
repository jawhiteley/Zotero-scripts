{
        "translatorID": "19bb6ee5-f7c3-4fd9-9b4a-35fb8b6220b1",
        "label": "RIS",
        "creator": "Simon Kornblith, modified by Jonathan Whiteley",
        "target": "ris",
        "minVersion": "2.1.3",
        "maxVersion": "",
        "priority": 100,
        ...
        "inRepository": false,
        "translatorType": 3,
        "lastUpdated": "2011-12-22 11:55:02"
}

/*jaw   Jonathan Whiteley   jonathan[cot]whiteley[at]mail[dot]mcgill[dot]ca
 * This is a modified version of the RIS translator included in Zotero 2.1.10:  32d59d2d-b65a-4da4-b0a3-bdd3cfb979e7
...
function processTag(item, tag, value) {
	...
	} else if(tag == "ED") {    //jaw: 'ED' field not in the spec?  EndNote typically uses 'A2' instead?
		var names = value.split(/, ?/);
