{
	"translatorID": "517051a5-cb19-499a-beb4-3b9f39638a13",
	"label": "RIS-EndNote",
	"creator": "Simon Kornblith and Aurimas Vinckevicius, modified by Jonathan Whiteley",
	"target": "ris",
	"minVersion": "3.0.4",
	"maxVersion": "",
	"priority": 50,
...
var EndNoteCleaner = new function() {
	...
	this.cleanTags = function(entry, item) {
        ...
        // Put Label field into "bibtex: <value>" in `extra` field - for compatibility with BBT. jaw
        //   see function processTag(), below
        // Replace file links with correct syntax: 'internal-pdf' -> file://location/of/your/pdfs  jaw
        //   The default translator already does this when cleaning pdf paths to a relative file path.
        //   see function processTag(), below (and processFields switch)
	}
};
...
function processTag(item, tagValue, risEntry) {
	...
	switch(tag) {
		...
		break;
		case "LB":  
            // jaw - I keep custom cite keys in the Label field in EndNote
