{
        ...
        "creator": "Simon Kornblith and Richard Karnesky, with modifications by Jonathan Whiteley, and tweaks by Andrew Leifer",
        "target": "bib",
        "minVersion": "2.1.9",
        "maxVersion": "",
        "priority": 300,
        ...
        "inRepository": false,
        "translatorType": 3,
        "lastUpdated": "2011-12-22 15:40:00"
}

/*This file is a hack so that Zotero will Drag & Drop citations in the form of a Bibtex "\cite{key}". 
 * This file is based on a modified "BibTex" translator from Zotero 2.1.10, with one notable exception.
 * Most of the output in the export section has been deleted so that it will only output \cite{key}.
 * This is inherently a hack. We don't really know Javascript. But it works. Enjoy.
 *
 * Original tweak & concept by Andrew Leifer:   leifer ( at ) fas ( dot ) harvard (dot) edu
